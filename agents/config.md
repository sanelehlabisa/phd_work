...
- Content: PhD papers on video processing and unusual human-activity classification from surveillance video.
...
- Formatting: Keep LaTeX readable and remove trailing whitespace.
- Generated files: Do not commit PDFs or build artifacts unless requested.
